...
# ============================================================================
# CodeGPT — Deployment Smoke
#
# Lightweight smoke test against an ALREADY-DEPLOYED CodeGPT instance.
...
#   CODEGPT_TOKEN="<your-secret>" \
#   bash scripts/smoke_deployment.sh
#
# Environment overrides:
#   CODEGPT_PUBLIC_URL  (or BASE_URL)  base URL of the deployed instance
#   CODEGPT_TOKEN       (or TOKEN)     bearer token; NEVER printed by this script
...
# Resolve base URL (CODEGPT_PUBLIC_URL preferred, BASE_URL fallback).
...
AUTH_HEADER_FILE="$(mktemp -t codegpt-smoke-auth-XXXXXX)"
