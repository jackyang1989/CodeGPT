...
- [README](../README.zh-CN.md) —— CodeGPT 能做什么，以及完整使用和临时试用的区别
...
- [快速试用](QUICK_START.zh-CN.md) —— 一条 `codegpt share` 临时体验一个仓库
...
protocol field、兼容名称和实现 invariant；普通用户不需要为了使用 CodeGPT 而学习
这些内容。
