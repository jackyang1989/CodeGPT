...
- **Windows** is an observability view for ChatGPT/CodeGPT call correlation. It
  lists hashed `ClientWindow` identities, current in-flight CodeGPT requests,
...
the next meaningful request start. The gap is explicitly outside-CodeGPT time;
