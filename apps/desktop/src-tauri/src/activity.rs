...
pub fn sanitize_message(message: &str) -> String {
    let mut safe = message
        ...
        .replace("authorization: bearer ", "authorization: [redacted]");
    for prefix in ["cg_pair_", "cg_pat_", "cg_agent_", "codegpt_temporary_"] {
...
mod tests {
    ...
    fn activity_redacts_runtime_credentials() {
        let safe = sanitize_message(
            "Authorization: Bearer abc cg_pair_secret cg_pat_secret cg_agent_secret codegpt_temporary_secret",
        );
