...
pub(crate) static LANGUAGES: &[LanguageProfile] = &[
    LanguageProfile {
        ...
        env_override: "CODEGPT_RUST_ANALYZER",
    ...
    LanguageProfile {
        ...
        env_override: "CODEGPT_TYPESCRIPT_LANGUAGE_SERVER",
...
/// Constrained read-only rust-analyzer profile for CodeGPT semantic
/// navigation.
///
/// CodeGPT LSP tools are read-only semantic navigation (document symbols,
...
/// - CodeGPT never changes the user's global Go telemetry mode; server-to-client
...
/// - effectful module/generate code lenses are disabled even though CodeGPT
