...
pub const EXTERNAL_SEARCH_REQUEST_PREFIX: &str = "# codegpt:search_project_text:v1";
...
pub const RUNNER_QUIC_ALPN_V1: &str = "codegpt-runner/1";
...
/// Runner-owned CodeGPT-generated POSIX programs execute through an explicit
...
pub struct RunnerRegisterRequest {
    ...
    /// by `codegpt-runner` at startup and reused for the whole process
...
mod envelope_tests {
    ...
    fn runner_protocol_compatibility_literals_are_exact() {
        assert_eq!(RUNNER_QUIC_ALPN_V1, "codegpt-runner/1");
        assert_eq!(
