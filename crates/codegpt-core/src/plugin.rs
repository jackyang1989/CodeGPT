...
//!
//! Plugins speak the CodeGPT Plugin Protocol over local stdio.  This module is
...
pub const PLUGIN_PROTOCOL_VERSION: &str = "codegpt-plugin-v1";
...
pub const PLUGIN_PROJECT_CATALOG_REVISION_PREFIX: &str = "cg_plugcat_";
...
fn plugin_catalog_digest_from_canonical_tools(tools: &[PluginTool]) -> Result<String, String> {
    ...
    hasher.update(b"codegpt.plugin-catalog.v1\0");
...
/// Return a bounded, stable CodeGPT-generated authoring diagnostic for a Tool
