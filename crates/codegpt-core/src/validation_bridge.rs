...
pub const VALIDATION_BRIDGE_RESULT_FORMAT: &str = "codegpt.validation_bridge_result.v1";
...
impl ValidationBridgeResultEnvelope {
    ...
    pub fn to_stdout_json(&self) -> String {
        serde_json::to_string(self).unwrap_or_else(|_| {
            r#"{"format":"codegpt.validation_bridge_result.v1","success":false,"error":{"code":"protocol_error","message":"failed to serialize result"}}"#
                .to_string()
        })
    }
}
