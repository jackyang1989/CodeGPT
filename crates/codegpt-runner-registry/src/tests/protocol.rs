...
async fn coding_agent_registration_rejects_semantically_contradictory_snapshot() {
    let registry = RunnerRegistry::default();
    let register =
        |run: codegpt_core::coding_agent::CodingAgentRunSnapshot| RunnerRegisterRequest {
            process_started_at: None,
            build: None,
            job_concurrency_limit: None,
            job_inventory: None,
            coding_agent_providers: Some(vec![codegpt_core::coding_agent::CodingAgentProvider {
                provider_id: "codex".to_string(),
    ...
    let base = codegpt_core::coding_agent::CodingAgentRunSnapshot {
        ...
        provider_instance_id: "provider_test".to_string(),
        state: codegpt_core::coding_agent::CodingAgentRunState::Running,
        execution_state: codegpt_core::coding_agent::CodingAgentExecutionState::Started,
        observation_revision: 1,
        created_at: 1,
        updated_at: 1,
        terminal: None,
    ...
    completed_with_refusal.terminal = Some(codegpt_core::coding_agent::CodingAgentTerminal {
...
async fn runner_supports_recognizes_all_protocol_capability_names() {
    ...
    registry
        .register(RunnerRegisterRequest {
            ...
            coding_agent_inventory: Some(
                codegpt_core::coding_agent::CodingAgentRunInventory::default(),
            ),
