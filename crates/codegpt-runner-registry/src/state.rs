...
use codegpt_core::mcp_gateway::McpGatewayResponse;
use codegpt_core::plugin::PluginGatewayResponse;
pub(super) use codegpt_core::runner_job_lifecycle::RunnerJobLifecycle as JobLifecycleState;
...
pub(super) struct ShellJobRecord {
    ...
    pub(super) validation: Option<codegpt_core::runner_protocol::ShellJobValidationMetadata>,
