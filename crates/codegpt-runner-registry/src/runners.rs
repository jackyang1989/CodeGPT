...
use codegpt_core::mcp_gateway::validate_providers;
...
impl RunnerRegistry {
    ...
    async fn register_session(
        ...
        let host_context = body
            .host_context
            .clone()
            .map(codegpt_core::runner_protocol::RunnerHostContext::normalized)
            .transpose()?;
        ...
        if let Some(inventory) = job_inventory.as_ref() {
            ...
            tracing::info!(
                target: "codegpt::job_reconciliation",
                client_id = %client_id,
    ...
    pub async fn update_runtime_metadata(
        ...
        client_id: &str,
        runner_instance_id: &str,
        tool_providers: Option<codegpt_core::runner_protocol::ToolProvidersStatus>,
        mcp_gateway_providers: Option<Vec<codegpt_core::mcp_gateway::McpGatewayProvider>>,
    ) -> Result<(), String> {
    ...
    pub async fn update_tool_providers(
        ...
        client_id: &str,
        runner_instance_id: &str,
        status: Option<codegpt_core::runner_protocol::ToolProvidersStatus>,
    ) -> Result<(), String> {
