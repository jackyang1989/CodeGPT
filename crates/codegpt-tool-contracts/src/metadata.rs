...
impl ToolIdempotency {
    pub const fn mcp_hint(self) -> bool {
        matches!(
            self,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ToolSemanticContract {
...
pub use codegpt_core::authority::ToolAuthorityPolicy;
...
pub struct ToolMetadata {
    ...
    pub authority: ToolAuthorityPolicy,
    pub requires_project: bool,
    pub path_hint: ToolPathHint,
    pub destructive: bool,
    pub shell_like: bool,
}

pub const RUNTIME_READ: &str = codegpt_core::authority::SCOPE_RUNTIME_READ;
pub const RUNNER_MANAGE: &str = codegpt_core::authority::SCOPE_RUNNER_MANAGE;
pub const SESSION_COLLABORATE: &str = codegpt_core::authority::SCOPE_SESSION_COLLABORATE;
pub const COMMUNICATION_READ: &str = codegpt_core::authority::SCOPE_COMMUNICATION_READ;
pub const COMMUNICATION_MANAGE: &str = codegpt_core::authority::SCOPE_COMMUNICATION_MANAGE;
pub const PROJECT_READ: &str = codegpt_core::authority::SCOPE_PROJECT_READ;
pub const PROJECT_WRITE: &str = codegpt_core::authority::SCOPE_PROJECT_WRITE;
pub const ADMIN: &str = codegpt_core::authority::SCOPE_ADMIN;
pub const JOB_RUN: &str = codegpt_core::authority::SCOPE_JOB_RUN;
pub const CODING_AGENT_RUN: &str = codegpt_core::authority::SCOPE_CODING_AGENT_RUN;
pub const BROWSER_READ: &str = codegpt_core::authority::SCOPE_BROWSER_READ;
pub const BROWSER_CONTROL: &str = codegpt_core::authority::SCOPE_BROWSER_CONTROL;
pub const BROWSER_LAUNCH: &str = codegpt_core::authority::SCOPE_BROWSER_LAUNCH;
pub const COMPUTER_READ: &str = codegpt_core::authority::SCOPE_COMPUTER_READ;
pub const COMPUTER_CONTROL: &str = codegpt_core::authority::SCOPE_COMPUTER_CONTROL;
pub const COMPUTER_LAUNCH: &str = codegpt_core::authority::SCOPE_COMPUTER_LAUNCH;
pub const COMPUTER_DISPLAY_READ: &str = codegpt_core::authority::SCOPE_COMPUTER_DISPLAY_READ;
pub const COMPUTER_POINTER_CONTROL: &str = codegpt_core::authority::SCOPE_COMPUTER_POINTER_CONTROL;
pub const COMPUTER_CLIPBOARD_READ: &str = codegpt_core::authority::SCOPE_COMPUTER_CLIPBOARD_READ;
pub const COMPUTER_CLIPBOARD_WRITE: &str = codegpt_core::authority::SCOPE_COMPUTER_CLIPBOARD_WRITE;
pub const PLUGIN_INSPECT: &str = codegpt_core::authority::SCOPE_PLUGIN_INSPECT;
pub const PLUGIN_INVOKE: &str = codegpt_core::authority::SCOPE_PLUGIN_INVOKE;
pub const PLUGIN_MANAGE: &str = codegpt_core::authority::SCOPE_PLUGIN_MANAGE;
pub const SSH_LOCAL: &str = codegpt_core::authority::SCOPE_SSH_LOCAL;
...
pub fn lookup_tool_metadata(name: &str) -> Option<&'static ToolMetadata> {
    super::tool_definition::lookup_tool_definition(name).map(|definition| &definition.metadata)
}

#[cfg(any(test, feature = "root-test-support"))]
pub fn iter_tool_metadata() -> impl Iterator<Item = ToolMetadata> {
...
mod tests {
    ...
    use codegpt_core::authority::SCOPE_PROJECT_READ;
    use codegpt_core::authority::{SCOPE_JOB_RUN, SCOPE_PROJECT_WRITE, SCOPE_RUNTIME_READ};
