...
fn edit_tool_surface_keeps_mutation_options_visible_and_schemas_stable() {
    ...
    assert_eq!(
        ...
        codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_CANDIDATE_POSITIONS
    );
    ...
    assert_eq!(
        ...
        codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_RECOVERY_READ_LINES
    );
