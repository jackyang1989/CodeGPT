use super::*;
use codegpt_core::runner_protocol::RAW_SHELL_COMMAND_MAX_BYTES;
use codegpt_core::workflow_session_contract::EXECUTION_PURPOSE_VALUES;
...
fn git_diff_hunks_page_budget_schema_defers_bounds_to_runtime_clamp() {
    ...
    assert_eq!(
        page["default"],
        codegpt_core::runtime_contract::DEFAULT_GIT_DIFF_HUNKS_PAGE_BYTES
    );
    assert_eq!(
        codegpt_core::runtime_contract::DEFAULT_GIT_DIFF_HUNKS_PAGE_BYTES,
        codegpt_core::runtime_contract::MAX_GIT_DIFF_HUNKS_PAGE_BYTES
    );
    ...
    let default_kib = codegpt_core::runtime_contract::DEFAULT_GIT_DIFF_HUNKS_PAGE_BYTES / 1024;
    let min_kib = codegpt_core::runtime_contract::MIN_GIT_DIFF_HUNKS_PAGE_BYTES / 1024;
    let max_kib = codegpt_core::runtime_contract::MAX_GIT_DIFF_HUNKS_PAGE_BYTES / 1024;
