...
fn sample_field_value(field: &str) -> Value {
    match field {
        ...
        "upload_id" => json!("cg_upload_test_1"),
        ...
        "agent_id" => json!("cg_dagent_qqqqqqqqqqqqqqqq".to_string()),
        "assignee_agent_id" => json!("cg_dagent_qqqqqqqqqqqqqqqq".to_string()),
        "task_id" => json!("cg_agent_task_ERERERERERERERER".to_string()),
        "wait_id" => json!("cg_agent_wait_ZmZmZmZmZmZmZmZm".to_string()),
        "events" => json!([{
            "kind": "agent_task_terminal",
            "task_id": "cg_agent_task_ERERERERERERERER".to_string()
        }]),
        "goal_id" => json!("cg_goal_AAAAAAAAAAAAAAAA".to_string()),
        "attempt_id" => json!("cg_agent_task_attempt_IiIiIiIiIiIiIiIi".to_string()),
        "attempt_fence" => json!("cg_agent_task_fence_MzMzMzMzMzMzMzMzMzMzMw".to_string()),
        "attempt_controller_generation" => json!(1),
        "outcome" => json!("succeeded"),
        "agent_ids" => json!(["cg_dagent_qqqqqqqqqqqqqqqq".to_string()]),
        "endpoint_id" => json!("cg_endpoint_u7u7u7u7u7u7u7u7".to_string()),
        "conversation_id" => json!("cg_conv_zMzMzMzMzMzMzMzM".to_string()),
        "delivery_ids" => json!(["cg_delivery_3d3d3d3d3d3d3d3d".to_string()]),
        "expected_profile_revision" => json!(1),
        "expected_controller_generation" => json!(1),
        "wake_id" => json!("cg_wake_7u7u7u7u7u7u7u7u".to_string()),
        "consume_token" => json!("cg_wake_consume______________________w".to_string()),
        "host" => json!("ChatGPT"),
        "body" => json!("hello"),
        "provider_id" => json!("codex"),
        "run_id" => json!("cg_agent_run_sample_1234"),
        "shell_id" => json!("cg_shell_123"),
        "session_id" => json!(format!("cg_sess_{}", "1".repeat(32))),
        "source" => json!("text('ok');"),
        "checkpoint_id" => json!("cg_ckpt_1234"),
        "confirm" => json!(true),
        "client_id" => json!("oe"),
        ...
        "message_id" => json!("cg_msg_0001"),
        "peer_id" => json!(format!("cg_peer_{}", "a".repeat(32))),
        "execution_context" => json!({}),
        "skill_id" => json!("cg_skill_EREREREREREREREREREREQ"),
...
pub(super) fn sample_tool_args_with_session(name: &str) -> Value {
    ...
    obj.insert(
        ...
        Value::String("cg_sess_accessor".to_string()),
    );
    args
}
