...
mod tests {
    ...
    fn reliability_tool_descriptions_are_selection_dense_and_keep_lifecycle_contracts() {
        ...
        assert!(
            wait.contains(
                &codegpt_core::runtime_contract::MAX_JOB_OBSERVATION_WAIT_SECS.to_string()
            ),
            "{wait}"
        );
