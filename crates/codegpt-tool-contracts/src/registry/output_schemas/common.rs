    ...
    suggested_tool_call_schema(
        ...
        json!({
            ...
            "properties": {
                ...
                "wait_secs": {
                    "type": "integer",
                    "const": codegpt_core::runtime_contract::MAX_JOB_OBSERVATION_WAIT_SECS,
                    "minimum": 1,
                    "maximum": codegpt_core::runtime_contract::MAX_JOB_OBSERVATION_WAIT_SECS
                },
...
pub fn authority_profile_schema(description: &str) -> Value {
    json!({
        ...
        "properties": {
            ...
            "source": {
                "type": "string",
                "description": "Where the resolved mode came from (default, env:CODEGPT_AUTHORITY_MODE, migrated_env:CODEGPT_PERMISSION_MODE, rejected_legacy_env:CODEGPT_PERMISSION_MODE)."
            },
            "project_write": {
                "type": "boolean",
    ...
    json!({
        ...
        "properties": {
            "minimum_tests": {
                "type": "integer",
                "minimum": 1,
                "maximum": codegpt_core::runner_protocol::CARGO_TEST_MIN_TESTS_MAX,
