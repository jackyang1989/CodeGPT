...
use codegpt_core::memory_contract::{
...
fn descriptor_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "memory_id": {"type":"string","pattern":"^cg_mem_[A-Za-z0-9_-]{16}$"},
            ...
            "revision": {"type":"string","pattern":"^cg_memrev_[A-Za-z0-9_-]{43}$"},
...
fn memory_scope_descriptor_schema() -> Value {
    json!({
        "type":"object",
        "properties": {
            "memory_scope_id":{"type":"string","pattern":"^cg_memscope_[A-Za-z0-9_-]{43}$"},
            ...
            "root_fingerprint":{"type":["string","null"],"pattern":"^cg_memroot_[A-Za-z0-9_-]{43}$"},
            "current_project_runtime_id":{"type":["string","null"]},
            "memory_count":{"type":"integer","minimum":1},
            "bootstrap_count":{"type":"integer","minimum":0},
            "catalog_revision":{"type":"string","pattern":"^cg_memcat_[A-Za-z0-9_-]{43}$"},
