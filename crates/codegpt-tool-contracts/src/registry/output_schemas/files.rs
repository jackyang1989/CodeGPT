...
fn suggested_read_files_arguments_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "max_result_bytes": {
                "type": "integer",
                "minimum": codegpt_core::runtime_contract::MIN_READ_FILES_RESULT_BYTES,
                "maximum": codegpt_core::runtime_contract::MODEL_INSPECTION_MAX_RESULT_BYTES
            }
        },
...
fn read_files_output_schema() -> Value {
    let default_limit = codegpt_core::runtime_contract::FILE_READ_DEFAULT_LIMIT;
