    ...
    json!({
        ...
        "properties": {
            ...
            "candidate_start_lines": {
                "type": "array",
                "minItems": 1,
                "maxItems": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_CANDIDATE_POSITIONS,
    ...
    json!({
        ...
        "properties": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "limit": {
                            "type": "integer",
                            "minimum": 1,
                            "maximum": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_RECOVERY_READ_LINES
                        }
                    },
            ...
            "change_index": {
                "type": "integer",
                "minimum": 0,
                "maximum": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_FILE_CHANGES - 1
            },
            "chunk_index": {
                "type": "integer",
                "minimum": 0,
                "maximum": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_CHUNKS_PER_FILE - 1
            }
        },
        "required": [
...
fn apply_patch_file_summary_schema() -> Value {
    json!({
        "type": "array",
        "maxItems": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_FILE_CHANGES,
        ...
        "items": {
            ...
            "properties": {
                ...
                "edits": {
                    "type": "array",
                    "maxItems": codegpt_core::apply_patch_shared::MAX_CODEX_PATCH_CHUNKS_PER_FILE,
