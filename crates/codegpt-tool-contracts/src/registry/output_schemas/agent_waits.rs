...
fn wait_source_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "task_id":{"type":"string","pattern":"^cg_agent_task_[A-Za-z0-9_-]{16}$","description":"Exact source identity only; no inherited Task authority."}
        },
...
fn wait_match_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "kind":{"type":"string","const":"agent_task_terminal"},
            "task_id":{"type":"string","pattern":"^cg_agent_task_[A-Za-z0-9_-]{16}$"},
            "task_attempt_id":{"type":"string","pattern":"^cg_agent_task_attempt_[A-Za-z0-9_-]{16}$"},
...
fn wait_schema() -> Value {
    json!({
        "type":"object","additionalProperties":false,
        "properties": {
            "wait_id":{"type":"string","pattern":"^cg_agent_wait_[A-Za-z0-9_-]{16}$"},
            "target_agent_id":{"type":"string","pattern":"^cg_dagent_[A-Za-z0-9_-]{16}$"},
