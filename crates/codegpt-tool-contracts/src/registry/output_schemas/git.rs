...
fn git_diff_hunks_recovery_arguments_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "max_page_bytes": {
                "type": "integer",
                "minimum": codegpt_core::runtime_contract::MIN_GIT_DIFF_HUNKS_PAGE_BYTES,
                "maximum": codegpt_core::runtime_contract::MAX_GIT_DIFF_HUNKS_PAGE_BYTES
            },
            "cached": {"type": "boolean"},
...
fn show_changes_handoff_arguments_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "max_page_bytes": {
                "type": "integer",
                "const": codegpt_core::runtime_contract::DEFAULT_GIT_DIFF_HUNKS_PAGE_BYTES
            }
        },
