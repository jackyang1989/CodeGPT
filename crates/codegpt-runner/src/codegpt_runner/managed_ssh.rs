...
fn managed_state_root(client_id: &str, server_url: &str) -> Result<PathBuf, &'static str> {
    let base = codegpt_runner_config::paths::default_client_state_base_dir()
...
fn storage_namespace(client_id: &str, server_url: &str) -> String {
    ...
    hasher.update(b"codegpt-runner-managed-ssh-v1\0");
                    ...
                    (
                        ...
                        ManagedResource {
                            ...
                            default_cwd: Some("x".repeat(
                                codegpt_core::ssh_resource::SSH_RESOURCE_DEFAULT_CWD_MAX_BYTES,
                            )),
                        },
                    )
                })
