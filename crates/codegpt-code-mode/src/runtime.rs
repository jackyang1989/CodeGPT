...
// Apache-2.0 licensed codex-rs/code-mode implementation. CodeGPT intentionally
...
fn spawn_runtime(source: String, allowed_tools: Vec<String>) -> Result<SpawnedRuntime, String> {
    ...
    let join = thread::Builder::new()
        .name("codegpt-code-mode-v8".to_string())
...
fn dynamic_import_callback<'s>(
    ...
    let error = v8::String::new(scope, "imports are not available in CodeGPT Code Mode")?;
