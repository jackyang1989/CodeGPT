//! Experimental transport-neutral JavaScript orchestration for CodeGPT.
//!
...
pub const MAX_CONCURRENT_EXECUTIONS_ENV: &str = "CODEGPT_CODE_MODE_MAX_CONCURRENT_EXECUTIONS";
