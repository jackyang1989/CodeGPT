//! Integration tests for `codegpt-process`.
//!
...
use codegpt_process::{GracefulTermination, ManagedChild, SpawnOptions};
...
/// `cargo test -p codegpt-process stress -- --ignored --nocapture`.
#[test]
