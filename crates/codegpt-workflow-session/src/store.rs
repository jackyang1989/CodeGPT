...
use codegpt_core::workflow_session_contract::{is_safe_job_id, PermissionDecision, SessionMode};
    ...
    pub fn start_session_with_options(
        ...
        let summary = {
            ...
            let session_id = inner
                .allocate_session_id(|| codegpt_core::compact::random_suffix::<12>())
...
impl SessionStoreInner {
    ...
    pub(super) fn post_message(
        ...
        let now = now_ts();
        let message_id =
            allocate_message_id(record, || codegpt_core::compact::random_suffix::<12>())?;
