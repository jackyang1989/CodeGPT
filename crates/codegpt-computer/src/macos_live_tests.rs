...
fn computer_macos_application_scan_is_bounded_symlink_safe_and_treats_apps_as_leaves() {
    ...
    create_test_application(&outer, "Outer", "dev.codegpt.outer");
    ...
    create_test_application(&outside, "Outside", "dev.codegpt.outside");
...
fn computer_macos_application_replacement_at_same_path_is_stale() {
    ...
    create_test_application(&application_path, "Replaceable", "dev.codegpt.replaceable");
