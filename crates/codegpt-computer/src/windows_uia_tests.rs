...
const WINDOWS_CONTROL_FIXTURE_TITLE: &str = "CodeGPT Windows UIA Control Smoke";
const WINDOWS_FOREGROUND_PROBE_TITLE: &str = "CodeGPT Windows UIA Foreground Probe";
...
$form.Text = 'CodeGPT Windows UIA Control Smoke'
...
[System.Windows.Forms.Application]::EnableVisualStyles()
$form = New-Object System.Windows.Forms.Form
$form.Text = 'CodeGPT Windows UIA Foreground Probe'
$form.StartPosition = 'Manual'
...
fn computer_windows_control_fixture_live_smoke() {
    ...
    let text = "codegpt computer smoke";
