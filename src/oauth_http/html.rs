...
<title>CodeGPT Authorize</title>
</head>
<body>
<h1>CodeGPT Authorization</h1>
<p>Sign in with a CodeGPT PAT to continue.</p>
{error_html}
<form method="post" action="/oauth/authorize/login">
  <input type="hidden" name="return_to" value="{return_to}">
  <label>CodeGPT token<br>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Authorize CodeGPT client</title>
</head>
<body>
<h1>Authorize CodeGPT client</h1>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Authorize CodeGPT project share</title>
</head>
<body>
<h1>Authorize CodeGPT project share</h1>
<p>Client: <strong>{client_name}</strong> ({client_id})</p>
<p>Redirect URI: <code>{redirect_uri}</code></p>
{resource_html}
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Authorize CodeGPT shared key</title>
</head>
<body>
<h1>Authorize CodeGPT shared key</h1>
<p>Client: <strong>{client_name}</strong> ({client_id})</p>
<p>Redirect URI: <code>{redirect_uri}</code></p>
{resource_html}
<h2>Standard access</h2>
<p>The OAuth request includes the following standard CodeGPT access:</p>
<ul>
{scope_items}
</ul>
{error_html}
